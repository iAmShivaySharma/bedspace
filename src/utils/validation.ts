...
export const providerVerificationSchema = z.object({
  ...
  businessPhone: z
    .string()
    .regex(/^[6-9]\d{9}$/, 'Invalid business phone number')
    .optional(),
});
...
export const createListingSchema = z.object({
  ...
  securityDeposit: z
    ...
    .max(500000, 'Security deposit must be less than ₹5,00,000'),
  ...
  availableFrom: z
    .string()
    .refine(date => new Date(date) >= new Date(), 'Available from date must be in the future'),
  coordinates: z
    .object({
...
export const searchSchema = z.object({
  ...
  genderPreference: z
    .enum([GENDER_PREFERENCES.MALE, GENDER_PREFERENCES.FEMALE, GENDER_PREFERENCES.ANY])
    .optional(),
...
export const bookingRequestSchema = z.object({
  ...
  requestedDate: z
    .string()
    .refine(date => new Date(date) >= new Date(), 'Requested date must be in the future'),
});
...
export const bookingResponseSchema = z.object({
  ...
  responseMessage: z
    .string()
    .max(500, 'Response message must be less than 500 characters')
    .optional(),
});
