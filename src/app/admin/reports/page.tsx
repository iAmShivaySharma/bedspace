...
export default function ReportsPage() {
  ...
  const exportReport = async (format: 'pdf' | 'csv') => {
    try {
      const response = await fetch(`/api/admin/reports/export?format=${format}&timeRange=${selectedTimeRange}&type=${selectedReportType}`);
      if (response.ok) {
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{reportData.userReports.totalUsers.toLocaleString()}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{reportData.listingReports.activeListings.toLocaleString()}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{reportData.bookingReports.totalBookings.toLocaleString()}</div>
                <p className="text-xs text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">₹{reportData.bookingReports.totalRevenue.toLocaleString()}</div>
                <p className="text-xs text-muted-foreground">
