          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div
                  className={`flex items-center mt-2 ${getGrowthColor(analytics.overview.revenueGrowth)}`}
                >
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div
                  className={`flex items-center mt-2 ${getGrowthColor(analytics.overview.bookingsGrowth)}`}
                >
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div
                  className={`flex items-center mt-2 ${getGrowthColor(analytics.overview.userGrowth)}`}
                >
          ...
          <CardContent className='p-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <div
                  className={`flex items-center mt-2 ${getGrowthColor(analytics.overview.ratingChange)}`}
                >
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='flex justify-between'>
              ...
              <span className='font-semibold'>
                {formatCurrency(analytics.listingMetrics.averagePrice)}
              </span>
            </div>
            <div className='flex justify-between'>
        ...
        <Card>
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='flex justify-between'>
              ...
              <span className='font-semibold'>
                {formatCurrency(analytics.bookingMetrics.averageBookingValue)}
              </span>
            </div>
          </CardContent>
        </Card>
