              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateSetting('booking', 'bookingFee', parseFloat(e.target.value))}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('booking', 'autoApprovalEnabled', checked)}
                  />
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => updateSetting('verification', 'verificationTimeout', parseInt(e.target.value))}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => updateSetting('verification', 'autoVerifyProviders', checked)}
                  />
                </div>
              </CardContent>
            </Card>
