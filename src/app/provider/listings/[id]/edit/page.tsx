...
import { useUpdateListingMutation, useGetProviderListingsQuery } from '@/lib/api/providerApi';
import { FACILITIES, INDIAN_STATES } from '@/constants';
...
export default function EditListingPage() {
  ...
  const {
    ...
    error,
  } = useGetProviderListingsQuery({ page: 1, limit: 1000 });
  ...
  useEffect(() => {
    if (listingData?.data) {
      const listing = listingData.data.find((l: any) => l._id === listingId);
      if (listing) {
        reset({
          title: listing.title,
        ...
        // Separate standard and custom facilities
        const standardFacilities =
          listing.facilities?.filter((f: any) => FACILITIES.includes(f as any)) || [];
        const customFacilitiesFromListing =
          listing.facilities?.filter((f: any) => !FACILITIES.includes(f as any)) || [];

        setSelectedFacilities(standardFacilities);
        setCustomFacilities(customFacilitiesFromListing);
      }
    }
  }, [listingData, reset, listingId]);
  ...
  if (error || !listingData?.data) {
    return (
      <DashboardLayout title='Edit Listing'>
        <div className='text-center py-12'>
          <h1 className='text-2xl font-bold text-gray-900 mb-4'>Listing Not Found</h1>
          <p className='text-gray-600 mb-6'>
            The listing you are trying to edit does not exist or you don't have permission to edit
            it.
          </p>
          <Button onClick={() => router.push('/provider/listings')}>
      ...
      <div className='space-y-6'>
        ...
        <div className='flex items-center space-x-4'>
          ...
          <div>
            ...
            <p className='text-gray-600'>Update your bed space listing details</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update the complete address of your property</CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update the rent and deposit amount</CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update available facilities and add custom ones</CardDescription>
            </CardHeader>
          ...
          {/* Media & Documents - Optional for edit */}
          <Card>
            <CardHeader>
              <CardTitle>Additional Media & Documents</CardTitle>
              <CardDescription>
                Upload additional images, videos, and documents (optional)
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-6'>
              {/* Note about existing media */}
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
                <p className='text-sm text-blue-800'>
                  <strong>Note:</strong> Any new files uploaded here will be added to your existing
                  media. To manage existing files, please contact support.
                </p>
              </div>
              ...
              <div>
                <div className='flex items-center justify-between mb-3'>
                  <h4 className='text-sm font-semibold'>Additional Property Images</h4>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update when this listing will be available for rent</CardDescription>
            </CardHeader>
            <CardContent>
              <div>
